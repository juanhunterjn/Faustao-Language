...
static const yytype_uint8 yyprhs[] =
{
      ...
      31,    35,    40,    45,    49,    53,    55,    59,    63,    67,
      71,    75,    79,    81,    83,    90,   101,   103,   105,   107,
     109,   111,   113,   115,   117,   119,   121,   125,   129,   133,
     137,   141
};
...
{
      34,     0,    -1,    35,    31,    -1,    38,    31,    -1,    39,
      31,    -1,     4,    31,    -1,     3,    36,    31,    -1,     3,
       7,    31,    -1,    34,    35,    31,    -1,    34,    39,    31,
      -1,    34,    38,    31,    -1,    34,     3,    36,    31,    -1,
      34,     3,     7,    31,    -1,    34,     4,    31,    -1,     6,
      21,    36,    -1,    37,    -1,    36,    23,    37,    -1,    36,
      24,    37,    -1,    36,    25,    37,    -1,    36,    26,    37,
      -1,    36,    32,    37,    -1,    36,    30,    37,    -1,     5,
      -1,     6,    -1,     8,    42,     9,     6,    21,    36,    -1,
      19,     6,    40,    36,    20,     6,    21,     6,    41,    37,
      -1,    12,    -1,    10,    -1,    11,    -1,    13,    -1,    17,
      -1,    18,    -1,    23,    -1,    24,    -1,    25,    -1,    26,
      -1,     6,    12,    36,    -1,     6,    10,    36,    -1,     6,
      11,    36,    -1,     6,    13,    36,    -1,     6,    17,    36,
      -1,     6,    18,    36,    -1
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      53,    54,    55,    56,    59,    62,    63,    64,    65,    66,
      67,    68,    71,    72,    75,    78,    81,    82,    83,    84,
...
{
  "$end", "error", "$undefined", "ESSAFERA", "OLOKOBIXO", "NUMERO",
  "LETRA", "PALAVRA", "BRINCADEIRAMEU", "EITA", "MENORIGUAL", "MAIORIGUAL",
  "IGUAL", "DIFERENTE", "OU", "E", "TAPEGANDOFOGOBIXO", "MAIOR", "MENOR",
  "CHURRASQUEIRAELETRICA", "FAZAOVIVO", "'='", "MENOSU", "'+'", "'-'",
  "'*'", "'/'", "'!'", "'<'", "'>'", "'%'", "';'", "'^'", "$accept",
  "LINE", "ATRIBUICAO", "EXPRESSAO", "TERMO", "CONDICIONALINTERNA",
  "LACOWHILE", "OPERADORRELACIONAL", "OPERADOR", "CONDICIONAL", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 59 "faustao.y"
    { updateCaracterValor((yyvsp[(1) - (3)].id),(yyvsp[(3) - (3)].num));}
    break;
...
/* Line 1455 of yacc.c  */
#line 72 "faustao.y"
    {(yyval.num) = caracterTk((yyvsp[(1) - (1)].id));}
    break;
...
/* Line 1455 of yacc.c  */
#line 75 "faustao.y"
    { updateCondicionalCaracterValor((yyvsp[(2) - (6)].num),(yyvsp[(4) - (6)].id),(yyvsp[(6) - (6)].num)); }
    break;
...
/* Line 1455 of yacc.c  */
#line 78 "faustao.y"
    { LACOWHILE((yyvsp[(2) - (10)].id),(yyvsp[(3) - (10)].num),(yyvsp[(4) - (10)].num),(yyvsp[(9) - (10)].num),(yyvsp[(10) - (10)].num)); }
    break;
...
/* Line 1455 of yacc.c  */
#line 95 "faustao.y"
    {(yyval.num) = statementIGUAL((yyvsp[(1) - (3)].id),(yyvsp[(3) - (3)].num));}
    break;
...
/* Line 1455 of yacc.c  */
#line 96 "faustao.y"
    {(yyval.num) = statementMENORIGUAL((yyvsp[(1) - (3)].id),(yyvsp[(3) - (3)].num));}
    break;
...
/* Line 1455 of yacc.c  */
#line 97 "faustao.y"
    {(yyval.num) = statementMAIORIGUAL((yyvsp[(1) - (3)].id),(yyvsp[(3) - (3)].num));}
    break;
...
/* Line 1455 of yacc.c  */
#line 98 "faustao.y"
    {(yyval.num) = statementDIFERENTE((yyvsp[(1) - (3)].id),(yyvsp[(3) - (3)].num));}
    break;
